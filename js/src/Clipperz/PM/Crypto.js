...
MochiKit.Logging.logDebug(">>> deferred (0.1): ");                                                                        
					var result;
...
MochiKit.Logging.logDebug(">>> deferredEncrypt (0.1): ");                                                                        
					var deferredResult;
		...
		//#####################################################################
			...
			'0.2': {
				...
				'decrypt': function(aKey, aValue) {
MochiKit.Logging.logDebug(">>> deferred (0.2): ");                                                                                                            
					var result;
				...
				'deferredDecrypt': function(aKey, aValue) {
MochiKit.Logging.logDebug(">>> deferredDecrypt (0.2): ");                                                                                                                                                
					var result;
...
//deferredResult.addBoth(function(res) {MochiKit.Logging.logDebug("Clipperz.PM.Crypto.deferredEncrypt - 3: " + res); return res;});
				...
				'decrypt': function(aKey, aValue) {
MochiKit.Logging.logDebug(">>> deferred (0.3): ");                                    
					var result;
				...
				'deferredDecrypt': function(aKey, aValue) {
MochiKit.Logging.logDebug(">>> deferredDecrypt (0.3): key " + aKey.toString() + ", value " + aValue.toString());
					var deferredResult;
//					var now;
